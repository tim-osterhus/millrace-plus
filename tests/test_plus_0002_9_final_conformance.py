...
MILLFORGE_PROFILE_DIGESTS = {
    (
        ...
        "PACKET_READY",
    ): "11437ac2efc0e6ed550e5184f94e88b467b839a7acbdb6de411d41bfb2fe2e28",
    (
        "BLOCKED",
        "FAILED",
        "INSUFFICIENT_SPEC",
        "WORK_DONE",
    ): "47aaccb09d9ce487bd024687e593eaba515a890d732e6905d8f6de8a198db032",
    (
        "ACCEPTED",
        "BLOCKED",
        "GAPS_FOUND",
        "INCIDENT_REQUIRED",
    ): "f86919c6fe1f0226e235d9ea3bf101dd2923cc139cddb5bc77c5f48810a3440f",
    (
        "OPERATOR_NEEDED",
        "RESOLVED",
        "UNRESOLVED",
    ): "6d7a89c247bbee2281232ea944681f3e1ee65cd165f1a36e51a592136bb24e45",
    (
        "BLOCKED",
        "BUILDER_COMPLETE",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "48b19fd6c83d77d0dfb9c40003d46d630397f21e01bbff9af31c6521de581e4b",
    (
        "BLOCKED",
        "CHECKER_PASS",
        "FIX_NEEDED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "7506b9a4878ff8a9e7454ae3933ce87fc375d784150d81ff703396178c89305c",
    (
        "BLOCKED",
        "FIXER_COMPLETE",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "bf222bd592772da2203588fa2ef20c913bd91064526d33b87b0361c8a553d83d",
    (
        "BLOCKED",
        "DOUBLECHECK_PASS",
        "FIX_NEEDED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "50ade3854d6c969afd16defa8383d4af8c2e0500f93b50abf542989a6571f227",
    (
        "BLOCKED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
        "UPDATE_COMPLETE",
    ): "9a831c602c06a464d2c488d9d962e4a51d35c6e4ddef62a3d0930205618af3a1",
    (
        "BLOCKED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ...
    ): "343b75d5f58521ad171d1e870b8a34ae7ec83b4dff4633b231e300e6e6b02a48",
    (
        "BLOCKED",
        "CONSULT_COMPLETE",
        "CONSULT_QUARANTINE",
        "CONSULT_RECOVERED",
        "NEEDS_PLANNING",
    ): "584a3e23b95c310989179b45efa20dedcb76016965a5617c5f616afc3fd3c559",
    (
        "BLOCKED",
        "INTEGRATION_COMPLETE",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "f1ba0918e27f21a92f49090f7e0183e0fcb5328f8ccce35c8a5fa8cd3cce7da7",
    (
        "BLOCKED",
        "RECON_BLOCKED",
        "RECON_NOOP",
        "RECON_TO_EXECUTION",
        "RECON_TO_PLANNING",
    ): "45a7b8533485fcf64514fa7503ae55b5e1dea1061bdd10dbf1cf57fb75c01c1f",
    ("BLOCKED", "PLANNER_COMPLETE"): (
        "41cd9613355587b2a9e0a430bc59b51b658792df80ad8fbfb2850517a433f230"
    ),
    ("BLOCKED", "MANAGER_COMPLETE"): (
        "44ba4ed3b5181d93fbd67442c9021f8e38c8319a63af3206894bff7ae36ea5ad"
    ),
    (
        "BLOCKED",
        "MECHANIC_COMPLETE",
        "MECHANIC_QUARANTINE",
        "MECHANIC_RECOVERED",
    ): "b81bbe72bc481b1944ec0136b5553d21a234091ba612640645fd878b3efdee7b",
    ("AUDITOR_COMPLETE", "BLOCKED"): (
        "6d03e91af4db73cbf9416c3c8a4c7ef1c21790780ed96a3292d214dcbad95ae7"
    ),
    ("ARBITER_COMPLETE", "BLOCKED", "REMEDIATION_NEEDED"): (
        "40d1d4ab008acabd7e578ad58aaac0e0955136fbaef72c79512d15822b025bd4"
    ),
    ("ANALYST_COMPLETE", "ANALYST_NOOP", "BLOCKED"): (
        "24e15809b9858ab32cec983584e2d90bb7b42d978b3cd5af9531d216045387e7"
    ),
    ("BLOCKED", "PROFESSOR_COMPLETE", "PROFESSOR_NOOP"): (
        "13c5e1d6402cf5178a562259009bebb1f04379640cbad5ee203128003ccd3b46"
    ),
    ("BLOCKED", "CURATOR_COMPLETE", "CURATOR_NOOP"): (
        "973df1b676b88979a88e80681609d6c794df5bb44b9da7ea9adac08338115694"
    ),
    ("BLOCKED", "LIBRARIAN_COMPLETE", "LIBRARIAN_NOOP"): (
        "0f8567f4c5a1f3d4d6bff07240ac668eeaa0aa671d21096bb2e7505b3c504ebf"
    ),
    ("REQUEST_NEEDS_CLARIFICATION", "REQUEST_READY"): (
        "30824d3c77e587b9f865b007ee318894306cb1d0bf81bed796d64d55531c1805"
    ),
    ("POLICY_ALLOWED", "POLICY_BLOCKED"): (
        "da624cace0637a4de6dcffa91d8a6611621f1f93abbe3c3389409e4e51773c32"
    ),
    ("REQUIREMENTS_READY",): (
        "56a332fcb825cf95d463ebd33c464b44c11253750e99e862d385557a06a9a364"
    ),
    ("CANDIDATES_READY", "NO_VIABLE_VENDOR"): (
        "4614035f0b593c208c57ec7867e33d5a0a740ca6af186c4a9c96c3c3c5f0de00"
    ),
    ("CANDIDATES_READY",): (
        "fdb85eb8498eb41b823ef8e89ac094299dddb878379cd3268b9d8ee422389038"
    ),
    ("RUBRIC_COMPLETE",): (
        "289d3de6126811e9f13624e8ec5783bc6f1ee10474497023aff0b8e77ae6643d"
    ),
    ("CONFLICT_COMPLETE",): (
        "fc43bbcf27d2bf49851db06f2c81a0171191e221d0188dcf08d284b8749fc06a"
    ),
    (
        "AWARD_READY",
        "BLOCKED",
        ...
        "OPERATOR_REQUIRED",
        "RESOURCE_REQUIRED",
    ): "3baf6807c0dc735cadb9cda9d2856148ac37df0e8f7ce1c304f3385a55cd9325",
    ("DECISION_PACK_READY",): (
        "d6e75048048ec554e29b1de49e09ca7278adb9cd358d9a9f797dcf9f17c0d03f"
    ),
}
