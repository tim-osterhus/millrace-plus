...
MILLFORGE_PROFILE_DIGESTS = {
    (
        ...
        "PACKET_READY",
    ): "9cf762277a9048d92fb937cfa9c922e83a572af0052a1c2b60b19b8258f53529",
    (
        "BLOCKED",
        "FAILED",
        "INSUFFICIENT_SPEC",
        "WORK_DONE",
    ): "2bfa4f03ae8d9a2ebfa820fbd1a55a5309d263df61b53df33bea05a2c2b66890",
    (
        "ACCEPTED",
        "BLOCKED",
        "GAPS_FOUND",
        "INCIDENT_REQUIRED",
    ): "598d1e3549a7862519daa41afd49b7731a71acdcabc8a8b63c5c755d518fb113",
    (
        "OPERATOR_NEEDED",
        "RESOLVED",
        "UNRESOLVED",
    ): "28c475e27ee0679cc0091fa96f376a0a4b1d3937ea8867c4874d8dd53af5c012",
    (
        "BLOCKED",
        "BUILDER_COMPLETE",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "89f1ec1748dc946446bfc2a5499652bdf59baff85c17e19ab8622544bcf6201b",
    (
        "BLOCKED",
        "CHECKER_PASS",
        "FIX_NEEDED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "70b430235ae8d9e175f3e293f17a1bae9e5090ecdb456dddac0418eb0e03eb18",
    (
        "BLOCKED",
        "FIXER_COMPLETE",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "741c46db3b98d0c927ad4deb0f6bcd0ae703e09a061a8cee4f0a54beb6dd1d61",
    (
        "BLOCKED",
        "DOUBLECHECK_PASS",
        "FIX_NEEDED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "92876bb9d55a993336f63ec6d2db722669dd3d935b08cc7b7d52d03b77cf74ae",
    (
        "BLOCKED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
        "UPDATE_COMPLETE",
    ): "3c6909c2b28d3da460083ea15eab05527980b4373e062e49417f5bc9ed42841d",
    (
        "BLOCKED",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ...
    ): "3eec492385be0b1f8f9be2f8c3550e7f5da2d776e4cd3c3b5c3c329e33835d72",
    (
        "BLOCKED",
        "CONSULT_COMPLETE",
        "CONSULT_QUARANTINE",
        "CONSULT_RECOVERED",
        "NEEDS_PLANNING",
    ): "9fcd8ab6051d5d66b591443ec93521175b3790b9b1d540db19bc85e16506b085",
    (
        "BLOCKED",
        "INTEGRATION_COMPLETE",
        "RUNTIME_FAILURE",
        "RUNTIME_FAILURE_ESCALATE",
    ): "74e352895f2dc7cf492c6ab233dde30fbe07049f7d1059ae896fe31e920020b3",
    (
        "BLOCKED",
        "RECON_BLOCKED",
        "RECON_NOOP",
        "RECON_TO_EXECUTION",
        "RECON_TO_PLANNING",
    ): "99de39b29d8eb0d2b2cfc1dfa42f28264c5630a0f1970839c69307fcb50af87d",
    ("BLOCKED", "PLANNER_COMPLETE"): (
        "c7479409a3c156d9f3c9e2b73d232e68a5b7ec54e88c150ba4093231eb8e8dd1"
    ),
    ("BLOCKED", "MANAGER_COMPLETE"): (
        "d9eb6f020817525df94edd47281515f2798b0d056c9421e688a202d05ce39e6b"
    ),
    (
        "BLOCKED",
        "MECHANIC_COMPLETE",
        "MECHANIC_QUARANTINE",
        "MECHANIC_RECOVERED",
    ): "3df5cafb846ff5a74800df41ebd39f36de2518e335a09b2998ba7d7a277c622d",
    ("AUDITOR_COMPLETE", "BLOCKED"): (
        "974b22b7ccda71315c967ccdf32466d2eac04614db650fee6da6b713029a86cf"
    ),
    ("ARBITER_COMPLETE", "BLOCKED", "REMEDIATION_NEEDED"): (
        "7de54272b610e702d9cf7e4121ce6ad505d2ec42305511b774c4c3d902002345"
    ),
    ("ANALYST_COMPLETE", "ANALYST_NOOP", "BLOCKED"): (
        "9c8e434f111cd5fa89ae895cbba3020718e0f6b956a99a5231d95f871e8155b6"
    ),
    ("BLOCKED", "PROFESSOR_COMPLETE", "PROFESSOR_NOOP"): (
        "b6f14ab2de231fbb311e27ba9023e711ba6436be9fc236cfe5349e58d2213395"
    ),
    ("BLOCKED", "CURATOR_COMPLETE", "CURATOR_NOOP"): (
        "a07f5dd4e9fa70d33d30b9db701d7bde5c518b15fb5a46b1a842d063ad3efbcc"
    ),
    ("BLOCKED", "LIBRARIAN_COMPLETE", "LIBRARIAN_NOOP"): (
        "aeead5d64461dc7c3f46dee42802eae2d802dc5c49d367c119c56ff71832f6c5"
    ),
    ("REQUEST_NEEDS_CLARIFICATION", "REQUEST_READY"): (
        "6f8f6ef76ea08258d74a5b366fc29aed05b681615586ceee8b64e9fbc4c3e1fd"
    ),
    ("POLICY_ALLOWED", "POLICY_BLOCKED"): (
        "93eae2d17fbefbb2ba30e3e63eb0de4363829b2f21eaf9e648474ca8f6e52740"
    ),
    ("REQUIREMENTS_READY",): (
        "a7b10797c20f42339f7f77bf571fbdaf7273fd8d0cdfc9df58045be544a1852b"
    ),
    ("CANDIDATES_READY", "NO_VIABLE_VENDOR"): (
        "df723ecffd45f3ec3f8dee462905c0d80509b314e257800b74038cd5f6303645"
    ),
    ("CANDIDATES_READY",): (
        "3e827d13831e22a38f31a478a1a82a68706ab39a3e4a8dac52c196e490f18f69"
    ),
    ("RUBRIC_COMPLETE",): (
        "f2d7fcfaef51dd89a72a162271fe81549583a391ce55a96739dea6917853d89f"
    ),
    ("CONFLICT_COMPLETE",): (
        "b2d552e278b1e706da6c67cc7153ca23833f9df7de0ea0b5f993d7b922516b41"
    ),
    (
        "AWARD_READY",
        "BLOCKED",
        ...
        "OPERATOR_REQUIRED",
        "RESOURCE_REQUIRED",
    ): "2bdec4ebc86c66d60c24e9a016406867c744d463580e592a924c522e01e85215",
    ("DECISION_PACK_READY",): (
        "239a0eed910056e65c5259b35b9e77673d4aecbe1ae4a93c8e324dc81c84fdec"
    ),
}
