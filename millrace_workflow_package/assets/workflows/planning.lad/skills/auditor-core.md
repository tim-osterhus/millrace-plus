...
description: Use when executing the lad_auditor stage for the selected Millrace planning workflow.
---

# Lad Auditor Core Skill
...
```json
{
  "terminal_marker": "AUDITOR_COMPLETE",
  "artifact": {
    "artifact_id": "bad-lad_auditor-wrapper",
    "artifact_kind": "planning.artifacts.stage_result",
    "fields": {
      "artifact_kind": "planning.artifacts.stage_result",
      "summary": "Planner summary."
...
Lad Auditor is complete only when it returns one legal terminal marker, one exact selected artifact body when required, and runner evidence/report text supporting the marker.
